...
public abstract class BaseRecyclerViewAdapter<T, VH extends BaseRecyclerViewAdapter.SparseArrayViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    protected void bindDataToItemView(VH vh, T item, int position) {
    ...
    public static class SparseArrayViewHolder extends RecyclerView.ViewHolder {
        ...
        public SparseArrayViewHolder setText(int viewId, Spanned value) {
            TextView view = getView(viewId);
            view.setText(value);
            return SparseArrayViewHolder.this;
        }
        ...
        public SparseArrayViewHolder setTag(int viewId, int id, Object tag) {
            View view = getView(viewId);
            view.setTag(id, tag);
            return SparseArrayViewHolder.this;
        }

        public SparseArrayViewHolder setImage(int viewId, String url) {
            ImageView view = getView(viewId);
            MyImageTool.getImg(view, url);
            return SparseArrayViewHolder.this;
        }

        public SparseArrayViewHolder setroundImg(int viewId, String url) {
            ImageView view = getView(viewId);
            MyImageTool.getroundImg(view, url);
            return SparseArrayViewHolder.this;
        }

        public SparseArrayViewHolder setSelect(int viewId, boolean select) {
            View view = getView(viewId);
            view.setSelected(select);
            return SparseArrayViewHolder.this;
        }

        public SparseArrayViewHolder setOnCheckedChangeListener(int viewId, CompoundButton.OnCheckedChangeListener select) {
            CheckBox view = getView(viewId);
            view.setOnCheckedChangeListener(select);
            return SparseArrayViewHolder.this;
        }

        public SparseArrayViewHolder setChecked(int viewId, boolean check) {
            CheckBox view = getView(viewId);
