...
import com.zrb.houserental.picker.AddressPicker;
import com.zrb.houserental.util.ConvertUtils;
...
public class AddressPickTask extends AsyncTask<String, Void, ArrayList<Province>> {
    ...
    protected ArrayList<Province> doInBackground(String... params) {
        if (params != null) {
            MyLogUtils.e("params.length  " + params.length);
        ...
        try {
            ...
            ArrayList<Province> child_data = gson.fromJson(json, new TypeToken<ArrayList<Province>>() {
            }.getType());
            data.addAll(child_data);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return data;
